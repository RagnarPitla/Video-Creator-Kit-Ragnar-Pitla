...
export const S18End: React.FC<z.infer<typeof s18Schema>> = ({
	...
	return (
		<AbsoluteFill style={{backgroundColor: '#EEF3F8'}}>
			...
			{/*
			 * Review note 12: this read "Mia" in a blue-to-pink ramp of its own,
			 * which was neither the opening lettering nor the opening colour. It
			 * now renders the same Wordmark component the title card uses, at 132
			 * rather than 150 so the three pillars still clear it. The centring
			 * row keeps the element shrink-to-fit, which is what makes the
			 * gradient run across the letters instead of across the frame.
			 */}
			<div
				style={{
					position: 'absolute',
