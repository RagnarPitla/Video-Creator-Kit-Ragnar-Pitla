 ...
 *
 * PROJECT-SPECIFIC: replace EVENTS with your own narration's claims and their
 * frames. Do not invent a benchmark to put here.
 *
...
const EVENTS: {at: number; label: string}[] = [
	...
	{at: 2900, label: 'Releases explained'},
