...
export const FILM_COPY = {
  ...
  s06: {
    vignettes: [
      ...
      {title: 'Solution Blueprint', body: 'Every finding stays connected'},
   ...
   * reliable, and repeatable." Review note 12: the wordmark is the full product
   * name, set in the opening title's lettering.
   *
   * The name went to "D365 Mia" in v12 and back to "Project Mia" in v14, on
   * Ragnar's correction. Keep the "j" descender in mind: the wordmark is
   * painted with background-clip, so it needs the lineHeight in Wordmark.tsx.
   *
   * The endorsement line under the wordmark is "Dynamics 365". It is doing a
   * different job from the wordmark: the wordmark is what the thing is called,
   * the lockup is the product family it ships inside. */
  s18: {
    lead: 'This is',
    wordmark: 'Project Mia',
